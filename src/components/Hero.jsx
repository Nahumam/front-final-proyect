        ...
        <>
            <section className="hero-container">
                <div className="left-hero-container">
                    ...
                    <button className="explore-more">Explora más <span className='arrow-rigth'><img width="50" height="50" src="https://img.icons8.com/ios-filled/50/FFFFFF/right--v1.png" alt="right--v1"/></span></button>
                </div>
