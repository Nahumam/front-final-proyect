        ...
        <>
            <section className='navbar-container'>
                ...
                <ul className='navbar-list'>
                    <NavItem title="Compre Ahora" dropdownItems={['Opción 1.1', 'Opción 1.2', 'Opción 1.3']} />
                ...
                <ul className='login-register'>
                    <li className='login'><button>Iniciar Sesión</button></li>
                    <li className='register'><button>Registrarse</button></li>
                </ul>
            </section>
        </>
    );
